...
We evaluate matched decoder pairs across three 3D medical image segmentation backbones: a large-kernel CNN (3D UX-Net \cite{lee20233d}), a vision transformer (SwinUNETR \cite{hatamizadeh2022swin}), and a ConvNeXt-style network (MedNeXt-M-K3 \cite{roy2023mednext}). Benchmarks are conducted across three diverse clinical datasets: the BTCV multi-organ CT dataset (13 organs) \cite{landman2015btcv}, the FeTA 2021 fetal brain MRI dataset (7 tissue structures) \cite{payette2021feta}, and the Medical Segmentation Decathlon Task08 HepaticVessel CT dataset (vessels and tumors) \cite{simpson2019large}.
