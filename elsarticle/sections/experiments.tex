...
\centering
\begin{tabular}{ccc}
\includegraphics[width=0.30\textwidth]{figures/obs-uxnet-concat/O_pareto.png} &
\includegraphics[width=0.30\textwidth]{figures/obs-swin-concat/O_pareto.png} &
\includegraphics[width=0.30\textwidth]{figures/obs-mednext/O_pareto.png} \\
(a) 3D UX-Net Concentration Curve & (b) SwinUNETR Concentration Curve & (c) MedNeXt-M-K3 Concentration Curve \\
\end{tabular}
...
\centering
\begin{tabular}{ccc}
\includegraphics[width=0.30\textwidth]{figures/obs-uxnet-concat/O3_unc_error.png} &
\includegraphics[width=0.30\textwidth]{figures/obs-swin-concat/O3_unc_error.png} &
\includegraphics[width=0.30\textwidth]{figures/obs-mednext/O3_unc_error.png} \\
(a) 3D UX-Net Predictability & (b) SwinUNETR Predictability & (c) MedNeXt-M-K3 Predictability \\
\end{tabular}
