...
\begin{figure*}[tb]
\centering
% --- Figure 6: Concentration (three backbones on one color-coded axis) ---
\includegraphics[width=0.6\textwidth]{figures/concentration_merged.png}
\caption{Oracle positive-gain concentration for the three backbones on a single color-coded axis. The gray dashed line is the random-selection baseline. In all three architectures the positive net gain is heavily concentrated, satisfying $K_{80} \le 5\%$: the top $5\%$ of spatial blocks already cover $\ge 97\%$ of the total positive gain, and the top $10\%$ cover essentially all of it.}
...
\end{tabular}
\caption{Signal-guided retrospective macro-Dice trajectories under output hybridization at increasing spatial budgets.}
