...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{Rethinking Decoder Redundancy in Efficient 3D Medical Image Segmentation: A Systematic Characterization Study}
...
% \input{sec/1_intro}      % boilerplate placeholder — real intro written last
\input{sec/4_experiments}
\input{sec/5_results}
% template guides retained but not compiled into the draft:
