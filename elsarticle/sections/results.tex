...
Across the two additional datasets, the absolute activity and net-gain rates varied with target morphology, but the three central observations were retained: gross correctness activity exceeded directional net gain, positive gain remained spatially concentrated, and uncertainty localized activity substantially better than it discriminated gain direction.
...
\textbf{MSD08 HepaticVessel} & 57.51 & 58.63 & \textit{[Pending]} & \textit{[Pending]} & \textit{[Pending]} & \textit{[Pending]} & \textit{[Pending]} & 0.865 & 0.520 \\
\bottomrule
\end{tabular*}
\end{table*}
